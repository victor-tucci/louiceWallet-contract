 ...
 * @author victor tucci (@ictor-tucci)
 */
contract AccountFacet is IAccountFacet, SafeHodlStorage, BaseAccount {
    ...
    function execute(address _dest, uint256 _value, bytes calldata _func, address _approveToken, bytes calldata _approveFunc) external {
        ...
        if(_approveToken != 0x0000000000000000000000000000000000000000){
